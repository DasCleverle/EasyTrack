...
#define TABLET_ITEMS    ["b_itemLAPTOP_FT", "o_itemLAPTOP_FT", "i_itemLAPTOP_FT"]
#define PDA_ITEMS       ["b_itemGPS_FT", "o_itemGPS_FT", "i_itemGPS_FT"]
#define TRACKER_ITEMS   (TABLET_ITEMS + PDA_ITEMS)
